...
#                videos_dir = os.path.join(videos_dir,year,month,day)
                ...
                if n_videos>0:
                    ...
                    if not filename.startswith("OUT"):
                        ...
                        n_videos = n_videos - 1
                    if filename.startswith("OUT") and check_if_done(video_name):
                        secs = 20
                                    ...
                                    if face_sums > 0:
                                        ...
                                        for i, item in enumerate(faces):
                                            ...
                                            if score > face_score_threshold:
                                                ...
                                                agender_starttime = time()
                                                gender,age = get_age_gender(agender_model,frame,bb)
                                                logger.info("Agender  cost time : {} s".format(round(time() - agender_starttime, 3)))  # mtcnn detect ,slow
...
#                                    break
                        ...
                        if os.path.exists(video_name):
                            ...
                            n_videos = n_videos - 1
                            print (" video removed from directory of camera 2 ...")
                
                if n_videos ==0:
                    print (" empty directory... waiting for new entries for camera 2")
...
if __name__ == '__main__':    
    main()
    logger.info("---- End of detection phase camera 2-----")
