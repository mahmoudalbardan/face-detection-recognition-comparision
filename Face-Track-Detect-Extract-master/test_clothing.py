                    ...
                    if filename.startswith("cam_in") and check_if_done(video_name):
                        ...
                        while True:
                                    ...
                                    if face_sums > 0:
                                        ...
                                        for i, item in enumerate(faces):
                                            ...
                                            if score > face_score_threshold:
                                                ...
                                                gender,age = "male",34
                                                #get_age_gender(agender_model,frame,bb)
                            ...
                            for d in trackers:
                                if not no_display:
                                    d = d.astype(np.int32)
                                    x,y = int(d[0] + d[2])/2, int(d[1] + d[3])/2
                                    x1,y1 = int(x-(x - d[0])*2.5), d[1]
                                    x2,y2 = int(x+(d[2] - x)*2.5), d[3]*2
                                    cv2.rectangle(frame, (x1,y1), (x2,y2), colours[d[4] % 32, :] * 255, 3)
                                    if final_faces != []:
...
def parse_args():
    ...
    parser.add_argument('--videos_dir', type=str,
                        ...
                        default='/Users/malbardan/Downloads/Face-Track-Detect-Extract-master/videos_cam1')
    ...
    parser.add_argument('--agender_weights',
                        ...
                        default="/Users/malbardan/Downloads/Face-Track-Detect-Extract-master/age_gender/pretrained_models/weights.28-3.73.hdf5")
